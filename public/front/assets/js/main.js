...
$(document).ready(function () {
    ...
    if (typeof noUiSlider === 'object') {
        ...
        var min = parseInt(priceSlider.getAttribute("data-min"));
        var max = parseInt(priceSlider.getAttribute("data-max"));
        var step = parseInt(priceSlider.getAttribute("data-step"));
        var end = parseInt(priceSlider.getAttribute("data-end"));
